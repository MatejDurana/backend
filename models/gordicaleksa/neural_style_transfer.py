...
if __name__ == "__main__":
    ...
    content_images_dir = default_resource_dir
    style_images_dir = default_resource_dir
    ...
    parser.add_argument("--content_img_name", type=str,
                        help="content image name", default='content_image.jpg')
    parser.add_argument("--style_img_name", type=str,
                        help="style image name", default='style_image.jpg')
